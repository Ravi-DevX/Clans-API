...
/**
 * Fired before a message is delivered to the sender's clan and allied clans.
 * <p>
 ...
 */
public class AllyChatMessageEvent extends Event implements Cancellable {
    ...
    public AllyChatMessageEvent(@NotNull Player player,
